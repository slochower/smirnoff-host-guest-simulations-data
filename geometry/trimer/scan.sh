...
prmtop="alpha_gaff.prmtop"      # The name of the topology file for the system
inpcrd="alpha_gaff.rst7"      # Some initial coordinate file (it will be replaced during the scan)
...
&rst iat=${atom5},${atom6},${atom7},${atom8} r1=${left}, r2=${dihedral}, r3=${dihedral}, r4=${right}, rk2=5000., rk3=5000., /
EOF
